...
// Photos come from picsum.photos: no key, no quota, no bill, and a stable
// image per seed string. Swap this one function for Cloudinary or your own
// CDN and every listing picks up the new source.
const photo = (seed: string, w = 1600, h = 1067) => `https://picsum.photos/seed/${seed}/${w}/${h}`;
